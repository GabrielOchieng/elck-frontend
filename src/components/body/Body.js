			...
			<div className="domtexts">
				...
				<div className="domeach" data-aos="fade-up">
					...
					<p>
						...
						language and mental concepts such as sorting, sequencing and
				...
				<div className="domeach" data-aos="fade-up">
					...
					<p>
						...
						development, interaction with the environment, view of self, moral
				...
				<div className="domeach" data-aos="fade-up">
					...
					<p>
						...
						work together, form meaningful friendships, resolve conflict and
						follow social norms. Emotional development – expressing emotions in
						a healthy way, having emotional needs met, feeling and recognising
				...
				<div className="domeach" data-aos="fade-up">
					...
					<p>
						...
						opportunities are based on skills first talent strategy. Clearly,
						our children need to be more future- ready. Because they will live
				...
				<div className="domeach" data-aos="fade-up">
					...
					<p>
						...
						protected from violence, exploitation and abuse. Child protection
						systems connect children to vital social services and fair justice
						systems – starting at birth
					</p>
				</div>
			</div>
		</div>
